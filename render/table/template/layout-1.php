<?php 
	...
	//Table Price
	if($params['price_font']){
		$table_price_style .= $params['price_font'];
	}
	...
	if($params['duration_font']){
		$table_price_duration_style .= $params['duration_font'];
	}
	...
	$tl_price_table = 'class="tl-price-table text-center '.$ani_style.'" '.$ani_duration.' '.(!empty($tl_price_table_style) ? 'style="'.$tl_price_table_style.'"' : '').'';
		...
		<?php if(!empty($params['price'])) :?>
			<div <?php print $entry_price; ?>>
				<div class="price-area">
					<span <?php print $pice_currency; ?>>
						<i class="<?php print (isset($params['price_currency']) ? $params['price_currency'] : ''); ?>"></i>
					</span>
					<span <?php print $table_price; ?>><?php print (isset($params['price']) ? $params['price'] : ''); ?><?php esc_html_e( '/', 'themelayer' ) ?></span>
					<span <?php print $pack_duration; ?>><?php print (isset($params['price_duration']) ? $params['price_duration'] : ''); ?></span>
				</div>
			</div>
		<?php endif;?>
