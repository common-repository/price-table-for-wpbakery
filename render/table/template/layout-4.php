<?php 
	...
	$tl_price_table = 'class="tl-price-table text-center style-three'.$ani_style.'" '.$ani_duration.' '.(!empty($tl_price_table_style) ? 'style="'.$tl_price_table_style.'"' : '').'';
		...
		<div class="entry-header">
			<div <?php print $entry_price; ?>>
				<div class="price-area">
					...
					<span><?php print (isset($params['price']) ? $params['price'] : ''); ?></span>
				</div>
				<div class="pack_duration">
					<h5><?php print (isset($params['price_duration']) ? $params['price_duration'] : ''); ?></h5>
				</div>
			</div>
		</div>
	<?php endif;?>
