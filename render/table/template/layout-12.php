<?php 
	...
	// Price Border Circle Color	
	if($params['price_circle_border']){
		$entry_price_style .= '
				border: '.$params['price_circle_border'].' solid '.$params['price_circle_color'].';
		';
	}
	...
	$tl_price_table = 'class="tl-price-table text-center style-twelve'.$ani_style.'" '.$ani_duration.' '.(!empty($tl_price_table_style) ? 'style="'.$tl_price_table_style.'"' : '').'';
	...
	<?php if(!empty($params['price'])) :?>
		<div class="entry-header">
			<div <?php print $entry_price; ?>>
				<div class="entry-qote">
					<div <?php print $table_price;?> class="price-area">
