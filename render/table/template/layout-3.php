<?php 
	...
	$tl_price_table = 'class="tl-price-table text-center three_style'.$ani_style.'" '.$ani_duration.' '.(!empty($tl_price_table_style) ? 'style="'.$tl_price_table_style.'"' : '').'';
		...
		<?php if(!empty($params['price'])) :?>
			<div <?php print $entry_price; ?>>
				<div class="price-area">
					...
					<span <?php print $table_price; ?>><?php print (isset($params['price']) ? $params['price'] : ''); ?></span>
				</div>
					
				<h5 <?php print $pack_duration; ?>><?php print (isset($params['price_duration']) ? $params['price_duration'] : ''); ?></h5>
			</div>
		<?php endif;?>
